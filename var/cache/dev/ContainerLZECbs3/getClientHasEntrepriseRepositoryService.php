 ...
 */
class getClientHasEntrepriseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ClientHasEntrepriseRepository' shared autowired service.
     *
     * @return \App\Repository\ClientHasEntrepriseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ClientHasEntrepriseRepository.php';

        return $container->privates['App\\Repository\\ClientHasEntrepriseRepository'] = new \App\Repository\ClientHasEntrepriseRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
