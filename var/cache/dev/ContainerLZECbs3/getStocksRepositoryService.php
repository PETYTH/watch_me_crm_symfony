 ...
 */
class getStocksRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\StocksRepository' shared autowired service.
     *
     * @return \App\Repository\StocksRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'StocksRepository.php';

        return $container->privates['App\\Repository\\StocksRepository'] = new \App\Repository\StocksRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
