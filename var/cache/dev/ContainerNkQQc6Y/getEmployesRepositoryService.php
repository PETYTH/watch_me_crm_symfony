 ...
 */
class getEmployesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmployesRepository' shared autowired service.
     *
     * @return \App\Repository\EmployesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmployesRepository.php';

        return $container->privates['App\\Repository\\EmployesRepository'] = new \App\Repository\EmployesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
