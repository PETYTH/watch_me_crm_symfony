 ...
 */
class getUserHasEntrepriseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserHasEntrepriseRepository' shared autowired service.
     *
     * @return \App\Repository\UserHasEntrepriseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserHasEntrepriseRepository.php';

        return $container->privates['App\\Repository\\UserHasEntrepriseRepository'] = new \App\Repository\UserHasEntrepriseRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
